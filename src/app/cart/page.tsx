  ...
  return (
    <div className="px-[50px] pb-[200px]">
      ...
      <div className="w-full max-w-[1500px] mx-auto">
        {data ? <CartItems data={data} /> : <EmptyCart />}
      </div>
        ...
        <tbody>
          <tr className="h-[149px] text-center text-[32px] font-semibold">
            <td className="table-cell relative">
              <p>
                106,400<span className="text-[17px]">원</span>
              </p>
            ...
            <td className="table-cell relative">
              <p>
                0<span className="text-[17px]">원</span>
              </p>
              <div className="absolute top-1/2 -translate-y-1/2 -right-[15px] size-[30px] bg-black rounded-full">
...
const EmptyCart = memo(function EmptyCart() {
  return (
    <div className="flex flex-col gap-[45px] items-center my-[100px] border-t-[4px] border-black border-b-[1px]">
